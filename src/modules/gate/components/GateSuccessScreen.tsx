...
interface GateSuccessScreenProps {
  title: string;
  subtitle: string;
...
export function GateSuccessScreen({
  title,
  subtitle,
  dashboardLabel,
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-background">
      ...
      <div className="flex flex-col gap-4 opacity-0 animate-fade-in-delay-3 sm:flex-row">
